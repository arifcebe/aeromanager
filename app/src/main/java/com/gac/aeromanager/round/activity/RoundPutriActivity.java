 ...
 */
public class RoundPutriActivity extends Fragment {
    ...
    private final String JK = "Pi";
    private static final String TAG = "ROUND PUTRi";

    ListView lv;
    public RoundPutriActivity(String round) {
        this.round = round;
    }
